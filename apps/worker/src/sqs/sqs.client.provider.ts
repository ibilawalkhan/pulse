...
/**
 * Builds the SQS client. With AWS_ENDPOINT_URL set (LocalStack locally) we use
 * an explicit endpoint + static test credentials; in production it is unset, so
 * the SDK targets real SQS and resolves credentials from the task IAM role.
 */
